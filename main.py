...
# Database configuration using raw string for the Windows path
...
@app.route('/')
def index():
    cafes = Cafe.query.all()  # Fetch all cafes from the 'cafe' table
